...
export function HeatingAndDHWAndClimateControlSection() {
  ...
  return (
    <div className="p-[var(--sectionPadding)]">
      ...
      <div className="flex  items-stretch gap-[9rem] max-[650px]:flex-col">
      ...
      <div className="flex flex-col gap-[2rem] max-[650px]:gap-[5rem]">
        <div className="flex  items-stretch gap-[9rem] max-[650px]:flex-col max-[650px]:gap-[3rem]">
